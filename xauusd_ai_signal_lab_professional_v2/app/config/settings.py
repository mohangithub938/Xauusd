...
# Paste your Groq key, Gmail sender, app password, and recipient here.
# These values are intentionally kept out of the dashboard UI.
DEFAULT_GROQ_KEY = "gsk_5c4dffca4a0ea92f4ee7e7b2d28a6cbf0b79ca4e9d18ee01"
...
class Settings:
    ...
    groq_key: str = os.getenv("GROQ_API_KEY", DEFAULT_GROQ_KEY)
